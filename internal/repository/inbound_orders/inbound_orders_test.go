...
func inboundOrdersSeeds(db *sql.DB) {
	// Create dependencies
	_, err := db.Exec(`
		INSERT INTO warehouses (id, address, telephone, warehouse_code, minimum_capacity, minimum_temperature) VALUES (1, '123 Main St', '555-1234', 'WH001', 100, -10.0);
		...
		INSERT INTO employees (id, card_number_id, first_name, last_name, warehouse_id) VALUES (1, 'EMP001', 'John', 'Doe', 1);
		INSERT INTO sections (id, section_number, current_temperature, minimum_temperature, current_capacity, minimum_capacity, maximum_capacity, warehouse_id, product_type_id) VALUES (1, 'SC-001', -10.0, -20.0, 50, 10, 100, 1, 1);
		INSERT INTO product_batches (id, batch_number, initial_quantity, current_quantity, current_temperature, minimum_temperature, due_date, manufacturing_date, manufacturing_hour, product_id, section_id) VALUES (1, '1', 200, 100, -10, -20, '2023-12-31', '2023-01-01', '08:00:00', 1, 1);
		INSERT INTO inbound_orders (id, order_date, order_number, employee_id, product_batch_id, warehouse_id) VALUES (1, '2023-01-01', 1001, 1, 1, 1);
	`)
	if err != nil {
		log.Fatal(err.Error())
	}
