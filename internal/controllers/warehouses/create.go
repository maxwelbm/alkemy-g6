...
func validateWarehouse(warehouse WarehouseReqJSON) error {
    ...
    if *warehouse.MinimumCapacity <= 0 {
        return errors.New("O campo minimum_capacity não pode ser negativo")
    }
...
func (c *WarehouseDefault) Create(w http.ResponseWriter, r *http.Request) {
    ...
    err = validateWarehouse(warehouseJSON)
    if err != nil {
